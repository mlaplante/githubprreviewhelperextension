 ...
 */
export const csharpSecurityRules = [
    {
        id: 'CS-SEC-001',
        ...
        remediation: 'Use parameterized queries with SqlCommand.Parameters or Entity Framework with LINQ. Never concatenate user input into SQL strings.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Use parameterized queries with SqlCommand.Parameters. String.Format should never be used for SQL query construction.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Use parameterized queries with SqlCommand.Parameters. String interpolation should never be used for SQL construction.',
        enabled: true,
        examples: {
            bad: 'string query = $"SELECT * FROM Users WHERE Id = {userId}";',
            good: 'using (SqlCommand cmd = new SqlCommand("SELECT * FROM Users WHERE Id = @id", connection))\n{\n  cmd.Parameters.AddWithValue("@id", userId);\n}',
    ...
    },
    {
        ...
        remediation: 'Validate and sanitize all input before passing to Process.Start. Better: use API calls instead of shell commands. Avoid user input in process arguments.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Validate file paths against a whitelist. Use Path.GetFullPath and ensure it doesn\'t escape the allowed directory. Consider using sandboxed file access.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Disable DTD processing and external entity resolution: xmlDoc.XmlResolver = null; or use XmlReaderSettings with ProhibitDtd = true.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Avoid BinaryFormatter entirely. Use JSON serialization (JsonSerializer, Newtonsoft.Json) or protobuf. If you must deserialize, use SerializationBinder to control types.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Use TypeNameHandling.None or TypeNameHandling.Objects with a custom SerializationBinder to restrict types.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Add [ValidateAntiForgeryToken] to POST, PUT, and DELETE actions. Include @Html.AntiForgeryToken() in forms.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Store connection strings in appsettings.json (not in source control) or use Azure Key Vault, AWS Secrets Manager, or similar.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Never store passwords in code. Use environment variables, configuration files (not in source control), or secure secrets management.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Use SHA256, SHA512, or other modern cryptographic algorithms. Use HMACSHA256 for message authentication codes.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Use Response.Write(HttpUtility.HtmlEncode(data)) or better yet, use Razor views with @data which auto-encodes.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Use Directory Services properly by parameterizing LDAP filters. Escape special characters or use proper LDAP query builders.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Never allow user-provided regex patterns. Use RegexOptions.IgnoreCase, not ReDoS-vulnerable patterns. Add timeout.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Always set Secure = true and HttpOnly = true on authentication cookies. Use response.Cookies.Add with proper flags.',
        enabled: true,
        examples: {
    ...
    },
    {
        ...
        remediation: 'Use RNGCryptoServiceProvider or the newer RandomNumberGenerator class for generating cryptographic random bytes.',
        enabled: true,
        examples: {
 ...
 */
export function getCSharpSecurityRules() {
